...
#Requires:	opt-perl(TIGR::AsmLib)
#Requires:	opt-perl(TIGR::FASTAgrammar)
#Requires:	opt-perl(TIGR::FASTAiterator)
#Requires:	opt-perl(TIGR::FASTAreader)
#Requires:	opt-perl(TIGR::FASTArecord)
