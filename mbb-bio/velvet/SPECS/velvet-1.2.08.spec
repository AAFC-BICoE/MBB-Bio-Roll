...
%build
# make 'MAXKMERLENGTH=31' 'CATEGORIES=5' 'OPENMP=1'
# cp velvetg Velvetg_31
# cp velveth Velveth_31
# make clean

# make 'MAXKMERLENGTH=63' 'CATEGORIES=5'  'OPENMP=1'
# cp velvetg Velvetg_63
# cp velveth Velveth_63
# make clean

# make 'MAXKMERLENGTH=127' 'CATEGORIES=5'  'OPENMP=1'
# cp velvetg Velvetg_127
# cp velveth Velveth_127
# make clean

# make 'MAXKMERLENGTH=145' 'CATEGORIES=5'  'OPENMP=1'
