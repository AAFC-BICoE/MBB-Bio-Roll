...
# script.
#
#    Package:           opt-perl-File-Slurp
#    Version:           9999.19
#    cpantorpm version: 1.08
#    Date:              Thu Oct 04 2018
#    Command:
# /opt/perl/bin/cpantorpm --add-require opt-perl --install-base /opt/perl --prefix opt-perl- --packager Rocks --spec-only File\:\:Slurp
#

Name:           opt-perl-File-Slurp
Version:        9999.19
Release:        1%{?dist}
...
BuildRoot:      /tmp/cpantorpm/File-Slurp-9999.19-inst
BuildArch:      noarch
Source0:        http://search.cpan.org/authors/id/authors/id/U/UR/URI/File-Slurp-9999.19.tar.gz
...
Provides:       opt-perl(File::Slurp) = 9999.19
Requires:       opt-perl
...
%setup  -n File-Slurp-9999.19
chmod -R u+w %{_builddir}/File-Slurp-%{version}
...
%changelog
* Thu Oct 04 2018 Rocks 9999.19-1
