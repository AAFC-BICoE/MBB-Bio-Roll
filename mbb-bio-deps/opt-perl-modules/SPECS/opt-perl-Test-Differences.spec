...
# script.
#
#    Package:           opt-perl-Test-Differences
#    Version:           0.64
#    cpantorpm version: 1.08
#    Date:              Thu Oct 04 2018
#    Command:
# /opt/perl/bin/cpantorpm --add-require opt-perl --install-base /opt/perl --prefix opt-perl- --packager Rocks --spec-only Test\:\:Differences
#

Name:           opt-perl-Test-Differences
Version:        0.64
Release:        1%{?dist}
...
BuildRoot:      /tmp/cpantorpm/Test-Differences-0.64-inst
BuildArch:      noarch
Source0:        http://search.cpan.org/authors/id/authors/id/D/DC/DCANTRELL/Test-Differences-0.64.tar.gz
...
Provides:       opt-perl(Test::Differences) = 0.64
Requires:       opt-perl
...
%setup  -n Test-Differences-0.64
chmod -R u+w %{_builddir}/Test-Differences-%{version}
