...
# script.
#
#    Package:           opt-perl-Package-Stash
#    Version:           0.37
#    cpantorpm version: 1.08
#    Date:              Thu Oct 04 2018
#    Command:
# /opt/perl/bin/cpantorpm --add-require opt-perl --install-base /opt/perl --prefix opt-perl- --packager Rocks --spec-only Package\:\:Stash
#

Name:           opt-perl-Package-Stash
Version:        0.37
Release:        1%{?dist}
...
BuildRoot:      /tmp/cpantorpm/Package-Stash-0.37-inst
BuildArch:      noarch
Source0:        http://search.cpan.org/authors/id/authors/id/D/DO/DOY/Package-Stash-0.37.tar.gz
...
Provides:       opt-perl(Package::Stash) = 0.37
Provides:       opt-perl(Package::Stash::PP) = 0.37
Requires:       opt-perl
Requires:       opt-perl(B)
...
%setup  -n Package-Stash-0.37
chmod -R u+w %{_builddir}/Package-Stash-%{version}
