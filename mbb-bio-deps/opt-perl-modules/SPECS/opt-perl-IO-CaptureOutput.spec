...
# script.
#
#    Package:           opt-perl-IO-CaptureOutput
#    Version:           1.1104
#    cpantorpm version: 1.08
#    Date:              Thu Oct 04 2018
#    Command:
# /opt/perl/bin/cpantorpm --add-require opt-perl --install-base /opt/perl --prefix opt-perl- --packager Rocks --spec-only IO\:\:CaptureOutput
#

Name:           opt-perl-IO-CaptureOutput
Version:        1.1104
Release:        1%{?dist}
...
BuildRoot:      /tmp/cpantorpm/IO-CaptureOutput-1.1104-inst
BuildArch:      noarch
Source0:        http://search.cpan.org/authors/id/authors/id/D/DA/DAGOLDEN/IO-CaptureOutput-1.1104.tar.gz
...
Provides:       opt-perl(IO::CaptureOutput) = 1.1104
Requires:       opt-perl
...
%setup  -n IO-CaptureOutput-1.1104
chmod -R u+w %{_builddir}/IO-CaptureOutput-%{version}
...
%changelog
* Thu Oct 04 2018 Rocks 1.1104-1
